...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(ItemAlreadyExistsInTheItemStorageException.class)
    ...
    @ExceptionHandler(ItemStorageException.class)
    ...
    @ExceptionHandler(ItemStorageNotFoundException.class)
    public ResponseEntity<String> handleItemStorageNotFoundException(ItemStorageNotFoundException e){
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("No item has been found in the repository! " + e.getMessage());
    }
    @ExceptionHandler(NotAllItemIdsFoundInRepositoryException.class)
    ...
    @ExceptionHandler(StorageItemIllegalQuantityException.class)
